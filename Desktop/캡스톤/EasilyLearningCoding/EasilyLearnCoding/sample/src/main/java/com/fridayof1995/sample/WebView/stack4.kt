...
class stack4 : AppCompatActivity() {
    @SuppressLint("SetJavaScriptEnabled")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_stack4)
        val pyWebView:WebView = findViewById(R.id.WebView_stack4)
        ...
        pyWebView.loadUrl("https://programmers.co.kr/learn/courses/30/lessons/42587")
    }
}